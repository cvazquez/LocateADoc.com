...
<cfoutput>
	<!-- main -->
	<div id="main" class="resources_compare">
		<cfif NOT isMobile>
					...
					<div id="content">
						...
						<div class="resources-box">
							...
							<cfif NOT isMobile>
								...
								<div class="resources_compare_ups3d" <!--- style="float:right;" --->>
						...
						<div class="holder compare-procedures print-area">
							...
							<form name="bodyform" method="post">
								<div class="styled-select" <!--- style="width: 195px; float:left; margin-right:10px;" ---> id="drop-body-region-selection">
								...
								<div id="body-part-selection-full-outer">
