<cfif UPS.RecordCount>
	<cfoutput>
		...
		<div id="dwindow" style="z-index:9999;position:absolute;cursor:hand;left:0px;top:0px;display:none;">
			...
			<table class="modal-box" style="width:#(UPS.Width+32)#px;height:#(UPS.Height+41)#px;">
				...
				<tr class="row-c">
					<td class="l"></td>
					<td class="c" style="width:#UPS.Width#px;height:#(UPS.Height)#px;">
						<div align="left" id="dwindowcontent" style="height:100%; background-color:##FFFFFF">
							<iframe id="cframe" src="" width="#UPS.Width#" height="#UPS.Height#" scrolling="no" border="0" style="border:none;" frameborder="0"></iframe>
						</div>
					</td>
				</tr>
				<tr class="row-b">
		...
		<div class="sidebox">
			<div class="frame">
				<h4>Patient <strong>Education</strong></h4>
				<div style="text-align:center; padding:10px;">
					<a href="javascript:loadwindow('#UPS.URL#',#(UPS.Width+32)#,#(UPS.Height+53)#)"><img  src="/images/profile/preview.jpg" width="200" border="0"></a>
				</div>
			</div>
		</div>
	</cfoutput>
