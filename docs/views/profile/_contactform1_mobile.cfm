...
<cfoutput>
	#javaScriptIncludeTag(source="facebook", head=true)#
  ...
  <div id="form-prompt"<cfif skipPrompt AND FacebookContactFormCombo EQ 0> style="display:none;"</cfif>>
	<cfif FacebookContactFormCombo EQ 0>
		...
		at <span style="color:##577B77;"><b><a tabIndex="-1" href="tel:#currentLocationDetails.phonePlus#">#formatPhone(currentLocationDetails.phonePlus)#</a></b></span></cfif>.</p>
	<cfelse>
  ...
  <div id="form-proper"<cfif not skipPrompt AND FacebookContactFormCombo EQ 0> style="display:none;"</cfif>>
	...
	<form name="addcontact" class="FBpop profile-contact-form" method="post">
		<fieldset>
			<div class="asterick">
			...
			<div class="row <cfif NOT addressRequired>not-</cfif>required">
				...
				<div class="styled-input"><input name="address" id="address" type="text" class="noPreText" value="#params.address#" /></div>
			</div>
			<div class="row required">
			...
			<div class="row required" style="padding-bottom: 8px;">
			...
			<div class="row required">
				...
				<div class="styled-input"><input name="postalCode" id="postalCode" type="text" class="noPreText" value="#params.postalCode#" /></div>
			</div>
			<div class="row required">
				<label <cfif ListFind(contactResult.errorList,"phone")>class="invalid-input" </cfif>for="Phone">Daytime Phone*</label>
				<div class="styled-input"><input name="Phone" id="Phone" type="text" class="noPreText" value="#params.Phone#" /></div>
			</div>
			<div class="row required">
			...
			<div class="row required" style="padding-bottom: 10px;">
				...
				<!--- <div style="width: 217px;" class="selectArea temporary"><span class="left"></span><span class="center">Select Age</span><a href="##" class="selectButton"></a></div> --->
					...
					<select name="age" id="age" <!--- class="hidefirst" --->>
		...
		<div class="btn" style="margin-left:auto; margin-right:auto;">
			<br />
