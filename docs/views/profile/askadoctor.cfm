...
<cfset styleSheetLinkTag(source="profile/askadoctor", head=true)>
<!-- content -->
	...
	<div class="welcome-box">
		...
		<div onclick="PromptOpen();" class="AskYourQuestion">Ask Your Question</a></div>
 		...
 		<cfif QA.recordcount gt 0>
			<cfif search.pages GT 1><div class="pagination">#includePartial("/shared/_pagination.cfm")#</div></cfif>
			...
			<cfloop query="QA">
				<div class="qa-holder comment">
					...
					<p>
						...
						#filteredContent#
						<a href="/ask-a-doctor/question/#QA.siloName#" style="font-size: smaller;">View&nbsp;full&nbsp;question&nbsp;&amp;&nbsp;answer&nbsp;&gt;&gt;</a>
					</p>
