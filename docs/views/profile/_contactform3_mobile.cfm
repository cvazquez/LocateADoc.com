...
<form name="addcontact" method="post" class="profile-contact-form3">
	<fieldset>
		...
		<cfoutput query="specialtyQuestions" group="id">
			<div class="row not-required">
				...
				<cfswitch expression="#fieldtype#">
					<cfcase value="text">
						<div class="styled-input"><input name="q_#id#" type="text" class="noPreText" value="#Evaluate('params.q_'&id)#" /></div>
					</cfcase>
					<cfcase value="select">
					...
					<cfcase value="checkbox">
						...
						<cfoutput>
							<p>
								...
								<label for="q_#id#_#checkboxCounter#" style="margin-left:0; float:none;">#display#</label>
							</p>
							<cfset checkboxCounter += 1>
						</cfoutput>
						</div>
					...
					<cfcase value="radio">
						...
						<cfoutput>
							<p>
								...
								<label for="q_#id#_#radioCounter#" style="margin-left:0; float:none;">#display#</label>
							</p>
							<cfset radioCounter += 1>
						</cfoutput>
						</div>
		...
		<div class="row not-required">
			<label <cfif ListFind(contactResult.errorList,"height")>class="invalid-input" </cfif>for="height" style="clear:left;float:none;margin:10px 0 5px 0;">Patient's Height</label>
				<div class="styled-select">
				<select name="height" id="height" class="comment-states">
		...
		<div class="row not-required">
			...
			<div class="styled-input"><input name="weight" id="weight" type="text" class="noPreText" value="#params.weight#" /></div><p class="lbs">&nbsp;lbs.</p>
		</div>
		<div class="row not-required">
			...
			<div class="radio-list">
				<p><input name="smoke" id="smoke_1" type="radio" value="1"<cfif params.time eq 1> checked</cfif> /> <label for="smoke_1" style="float:none;margin-left:0;">Yes</label></p>
				<p><input name="smoke" id="smoke_2" type="radio" value="0"<cfif params.time eq 0> checked</cfif> /> <label for="smoke_2" style="float:none;margin-left:0;">No</label></p>
			</div>
		</div>
		<div class="row not-required">
			...
			<div class="radio-list">
				<p>
					...
					<label for="contactoption1" style="margin-left:0; float:none;">By Phone</label>
				</p>
				<p>
					...
					<label for="contactoption2" style="margin-left:0; float:none;">By Mail</label>
				</p>
				<p>
					...
					<label for="contactoption3" style="margin-left:0; float:none;">By Email</label>
				</p>
			</div>
		</div>
		<div class="row not-required">
		...
		<cfloop from="1" to="6" index="i">
			...
			<div class="row not-required">
				<label <cfif ListFind(contactResult.errorList,"question#i#")>class="invalid-input" </cfif>for="weight" style="float:none;margin-left:0;>#Evaluate("doctor.question" & i)#</label>
				<div class="styled-input"><input name="question#i#" id="question#i#" type="text" class="noPreText" value="#Evaluate('params.question'&i)#" /></div>
			</div>
			</cfif>
		</cfloop>
		<cfif currentLocationDetails.hasSeminar eq 1>
			<div class="row show-name required">
				...
				<label style="float:none;margin-left:0;" for="seminar">I am interested in attending an educational event to learn more about #topSpecialties.name#?</label>
			</div>
		</cfif>
		<cfif topSpecialties.isPremier eq 1>
			<div class="row show-name required">
				...
				<label style="float:none;margin-left:0;" for="financing">I would like financing information to help pay for the patient's procedure.*</label>
