<cfoutput>
	<div class="small-block image-block"
		...
		<div class="frame">
			<a href="/resources/blog-list" style="text-decoration:none;"><h4>From Our <strong>Blog</strong></h4></a>
			<cfif Blog.recordcount>
				...
				<em style="display: block; font-style: normal;color: ##6c6c6c; font: 12px BreeRegular, Arial, Helvetica, sans-serif;">#DateFormat(Blog.post_date,"mm.dd.yy")#</em>
