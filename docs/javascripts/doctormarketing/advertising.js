...
var advertisingInterfaceInitialized = false;
function initAdvertisingInterface(){
	if(!advertisingInterfaceInitialized){
		...
		advertisingInterfaceInitialized = true;
	}
}

function changeOptionImage(targetImage){
	initAdvertisingInterface();
...
$(function(){
	$(".advertising-options li>a").click(function(){
